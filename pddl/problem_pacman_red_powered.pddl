;;Scenario&Assumption: In each team, there is a offensive pacman that concentrates on eating dots, and a defensive ghost that never across the middle line. If the pacman is powered, it is not afraid of ghost, and it has no interest in eating the ghost.

(define (problem pacman_red_powered)
	...
	(:goal
		(and
			...
			(not (foodAt loc_25_9))
			(not (foodAt loc_29_9))
			(not (foodAt loc_18_10))
			(not (foodAt loc_22_10))
			(not (foodAt loc_24_10))
			(not (foodAt loc_25_10))
			(not (foodAt loc_22_12))
			(not (foodAt loc_23_12))
			(not (foodAt loc_27_13))
			(not (foodAt loc_22_15))
			(not (foodAt loc_24_15))
			(not (foodAt loc_27_15))
			(or
				(pacmanAt loc_16_1)
				(pacmanAt loc_16_2)
				(pacmanAt loc_16_3)
